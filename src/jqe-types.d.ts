...
type BodyType = BODY_LIGHT_WORKER | BODY_MINER | BODY_HAULER | BODY_REMOTE_MINER | BODY_DEFENDER | BODY_SCOUT | BODY_REMOTE_DEFENDER | BODY_REMOTE_CLAIMER | BODY_RUNNER;
type RoleType = ROLE_HARVESTER | ROLE_UPGRADER | ROLE_BUILDER | ROLE_MINER | ROLE_MECHANIC | ROLE_HAULER | ROLE_SCOUT | RemoteRoleType | ROLE_DEFENDER | ROLE_RUNNER;
