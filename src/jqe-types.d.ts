...
type BODY_SCOUT_CLAIMER = "scoutclaimer";
type BODY_RUNNER = "runner";
...
declare var BODY_SCOUT_CLAIMER: BODY_SCOUT_CLAIMER;
declare var BODY_RUNNER: BODY_RUNNER;
...
type ROLE_SCOUT_CLAIMER = "rolescoutclaimer";
type ROLE_DEFENDER = "roledefender";
type ROLE_RUNNER = "rolerunner";
...
declare var ROLE_SCOUT_CLAIMER: ROLE_SCOUT_CLAIMER;
declare var ROLE_DEFENDER: ROLE_DEFENDER;
declare var ROLE_RUNNER: ROLE_RUNNER;
...
type BodyType = BODY_LIGHT_WORKER | BODY_MINER | BODY_HAULER | BODY_REMOTE_MINER | BODY_DEFENDER | BODY_SCOUT | BODY_REMOTE_DEFENDER | BODY_REMOTE_CLAIMER | BODY_RUNNER | BODY_SCOUT_CLAIMER;
type RoleType = ROLE_HARVESTER | ROLE_UPGRADER | ROLE_BUILDER | ROLE_MINER | ROLE_MECHANIC | ROLE_HAULER | ROLE_SCOUT | RemoteRoleType | ROLE_DEFENDER | ROLE_RUNNER | ROLE_SCOUT_CLAIMER;
