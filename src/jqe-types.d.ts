...
type BodyType = BODY_LIGHT_WORKER | BODY_MINER | BODY_HAULER | BODY_REMOTE_MINER | BODY_DEFENDER | BODY_SCOUT | BODY_REMOTE_DEFENDER;
...
type RemoteRoleType = ROLE_REMOTE_MINER | ROLE_REMOTE_DEFENDER;
